...
namespace TMPro.EditorUtilities
{
    ...
    public static class TMP_UIStyleManager
    {
        ...
        public static void GetUIStyles()
        {
            ...
            if (TMP_GUISkin != null)
            {
                Label = TMP_GUISkin.FindStyle("Label") ?? GUIStyle.none;
                ...
                Section_Label = TMP_GUISkin.FindStyle("Section Label") ?? GUIStyle.none;
                Group_Label = TMP_GUISkin.FindStyle("Group Label") ?? GUIStyle.none;
                Group_Label_Left = TMP_GUISkin.FindStyle("Group Label - Left Half") ?? GUIStyle.none;
                TextAreaBoxEditor = TMP_GUISkin.FindStyle("Text Area Box (Editor)") ?? GUIStyle.none;
                TextAreaBoxWindow = TMP_GUISkin.FindStyle("Text Area Box (Window)") ?? GUIStyle.none;
                TextureAreaBox = TMP_GUISkin.FindStyle("Texture Area Box") ?? GUIStyle.none;
                SquareAreaBox85G = TMP_GUISkin.FindStyle("Square Area Box (85 Grey)") ?? GUIStyle.none;
